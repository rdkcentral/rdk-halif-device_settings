 ...
 * For the source devices,if MS12 DAP Intelligent Equalizer not supported, then this function retuns dsERR_OPERATION_NOT_SUPPORTED
 *
 * @param[in] handle - Handle for the output audio port.
 ...
 * For the source devices,if MS12 DAP bass enhancer not supported, then this function retuns dsERR_OPERATION_NOT_SUPPORTED
 *
 * @param[in] handle  - Handle for the output Audio port
 ...
 * For the source devices,if MS12 DAP surround decoder not supported, then this function retuns dsERR_OPERATION_NOT_SUPPORTED
 *
 * @param[in] handle   - Handle for the output Audio port
 ...
 * For the source devices,if MS12 DAP surround virtualizer not supported, then this function retuns dsERR_OPERATION_NOT_SUPPORTED
 *
 * @param[in] handle       - Handle for the output Audio port
 ...
 * For the source devices, this function retuns dsERR_OPERATION_NOT_SUPPORTED always.
 *
 * @param[in] handle    - Handle for the output Audio port
 ...
 *
 * For the source devices,if LE not supported, then this function retuns dsERR_OPERATION_NOT_SUPPORTED
 *
 * @param[in] handle  - Handle of the output audio port
