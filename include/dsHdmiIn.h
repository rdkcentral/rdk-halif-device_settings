...
* @param[in] vrrStatus  - Current VRR type and VRR Frame Rate to be notified to the application. Please refer ::dsHdmiInVrrStatus_t
*
...
*
* @param[in] port      - HDMI input port. Please refer ::dsHdmiInPort_t
* @param[out] vrrStatus  - The current VRR type and VRR  Frame  Rate to be notified to application. Please refer ::dsHdmiInVrrStatus_t
*
* @return dsError_t                        - Status
* @retval dsERR_NONE                       - Success
* @retval dsERR_NOT_INITIALIZED            - Module is not initialized
