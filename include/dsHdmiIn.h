 ...
 * @param [in]audioMix    	whether the audio mix is true or false
 * @param [in]evideoPlaneType 	video plane to be selected
 * @param [in]topMost 	        input port should be over/under the selected plane
 * @return Device Settings error code
 * @retval    ::dsError_t
 */
