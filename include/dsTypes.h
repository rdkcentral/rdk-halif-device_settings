...
typedef enum _dsTVResolution_t{
    ...
    dsTV_RESOLUTION_1080p25 = 0x00800,      /**< 1080p25 Resolution.                     */
    dsTV_RESOLUTION_1080p30 = 0x01000,      /**< 1080p30 Resolution.                     */
    dsTV_RESOLUTION_1080i50 = 0x02000,      /**< 1080i50 Resolution.                     */
    dsTV_RESOLUTION_1080p50 = 0x04000,      /**< 1080p50 Resolution.                     */
    dsTV_RESOLUTION_1080p60 = 0x08000,      /**< 1080p60 Resolution.                     */
    dsTV_RESOLUTION_2160p24 = 0x10000,      /**< 2160p24 Resolution.                   */
    dsTV_RESOLUTION_2160p25 = 0x20000,      /**< 2160p25 Resolution.                   */
    dsTV_RESOLUTION_2160p30 = 0x40000,      /**< 2160p30 Resolution.                   */
    dsTV_RESOLUTION_2160p50 = 0x80000,      /**< 2160p50 Resolution.                   */
...
typedef enum _dsHDRStandard_t {
    dsHDRSTANDARD_NONE = 0x0,           /**< When No video in decoded */
    ...
    dsHDRSTANDARD_TechnicolorPrime = 0x8, /**< Video Format Techinicolor Prime */
...
typedef enum _dsAudioPortState {
 ...
 /** @addtogroup DSHAL_HDMI_IN_TYPES Device Settings HAL HDMI IN AVI Info Content Type Definitions
 *  @ingroup DSHAL_HDMI_IN
 *  @{
 */
...
typedef enum dsVideoPlaneType {
    dsVideoPlane_PRIMARY,
    dsVideoPlane_SECONDARY,
    dsVideoPlane_INVALID
}dsVideoPlaneType_t;
