 ...
 * to the application
 *
 * @param videoFormat     Current video format of the content playing
 *
 * @return None.
 */
 ...
 *
 * @param[in] handle    - Handle of the video port returned from dsGetVideoPort()
 * @param[in] cb        - Callback function. Please refer ::dsHDCPStatusCallback_t
 * 
 * @return dsError_t                      -  Status 
 * @retval dsERR_NONE                     -  Success
 * @retval dsERR_INVALID_PARAM            -  Parameter passed to this function is invalid
 ...
 * "port"         "on", "off"
 *
 * @param[in] handle - a name of parameter
