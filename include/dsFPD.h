 ...
 *
 * @param[in] eIndicator     -  FPD Indicator index (Power LED, Record LED, and so on). Please refer ::dsFPDIndicator_t
 * @param[in] eBrightness    -  The brightness value for the specified indicator. Please refer ::dsFPDBrightness_t
 ...
 *
 * @param[in] eIndicator      -   FPD Indicator index (Power LED, Record LED and so on). Please refer ::dsFPDIndicator_t
 * @param[in] eColor          -   Indicates the RGB color to be set for the specified LED. Please refer ::dsFPDColor_t
 * @param[in] toPersist       -   Indicates whether to persist the specified LED color or not.
 *                                (If TRUE persists the LED colour else doesn't persist it)
 *
 * @return dsError_t                      -  Status
 * @retval dsERR_NONE                     -  Success
 * @retval dsERR_GENERAL                  -  Underlying undefined platform error
