...
/**
 * @brief This function returns the supported led states
 *
 * @param[out] return the bitwise value of all supported led states by the platform
 *
 * @return front panel error code
 * @retval dsERR_NONE Indicates api was successful
 * @retval dsERR_GENERAL Indicates error due to general failure.
 */
dsError_t dsFPGetSupportedLEDStates (unsigned int* states);

/**
 * @brief This function returns the current led state
 *
 * @param[out] returns current led state
 *
 * @return front panel error code
 * @retval dsERR_NONE Indicates api was successful
 * @retval dsERR_GENERAL Indicates error due to general failure.
...
/**
 * @brief This function sets the led state
 *
 * @param[in] let state to set
 *
 * @return front panel error code
 * @retval dsERR_NONE Indicates api was successful
 * @retval dsERR_GENERAL Indicates error due to general failure.
